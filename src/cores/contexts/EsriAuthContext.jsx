...
const EsriAuthContext = createContext();

export const EsriAuthProvider = ({ children }) => {
  ...
  return (
    <EsriAuthContext.Provider value={{ user,isAuth,setIsAuth,isLoading, setIsLoading,loginAsync, logout,setResvRightsAsync }}>
      {children}
    </EsriAuthContext.Provider>
  );
};

export const useEsriAuth = () => useContext(EsriAuthContext);
